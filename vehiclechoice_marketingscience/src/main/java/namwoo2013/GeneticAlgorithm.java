...
public class GeneticAlgorithm {
    ...
    public GeneticAlgorithm(
            ...
            double[][] X, double[][] SV, double[] w, double lambda, 
        ...
        while (nextGeneration.getPopulationSize() < nextGeneration.getPopulationLimit()) {
            ...
            if (randGen.nextDouble() < getMutationRate()) {
                ...
                pair = new ChromosomePair(
                    getMutationPolicy().mutate(pair.getFirst(), X, SV, w, lambda, mean, std, INDa, INDb, INDc, obj, allX),
                    getMutationPolicy().mutate(pair.getSecond(), X, SV, w, lambda, mean, std, INDa, INDb, INDc, obj, allX));
            }
